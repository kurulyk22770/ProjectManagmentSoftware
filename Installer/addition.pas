...
begin
  ...
  begin
    V := MsgBox(ExpandConstant('WARNING! Old version of ProjectManagmentSoftware is found on your computer. Do you want to uninstall it?'), mbInformation, MB_YESNO); //Custom Message if App installed
    if V = IDYES then
    begin
  ...
  if not IsDotNetDetected('v4\Client', 0) then 
	begin
        V := MsgBox('ProjectManagmentSoftware requires Microsoft .NET Framework 4.0 Client Profile.'#13#13
